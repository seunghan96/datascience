...
The posterior mean and effective sample size looks like below.
- Poisson likelihood
- prior : <a href="https://www.codecogs.com/eqnedit.php?latex=\frac{\alpha}{\beta}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\frac{\alpha}{\beta}" title="\frac{\alpha}{\beta}" /></a>
- posterior : 
